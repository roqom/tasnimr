...
What I have come to appreciate in the Ash'ari framework is that metaphysics cannot be governed by a single rule applied universally. When there is a need to minimize, one minimizes. When there is a need to maximize, one maximizes. This produces a metaphysics that is careful and robust, though results in certain complexity and sometimes what feels like redundancy.
