Generally, I tend to lean towards minimalism in many things that I do or choose. Whether in design, aesthetic, traveling, wearables, relationship, etc, I operate under the principle "less but better".  Minimalism values simplicity, essential, necessary, light-weight. However I realized this can be dangerous when taken too far into the realm of metaphysics.
...
All those issues, causes a fork in the framework which the Ashari came and eloquently solve them. It is the Ashari framework that I came to realized when there's a need to maximize things you must maximize. And when there's a need to minimize, you minimize. The Ashari is all about moderation and putting things where it is due. It is the balance between minimalism(Mu'tazila) and maximalism(Anthropomorphism) in ontology.
